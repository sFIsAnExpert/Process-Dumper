...
namespace ImGui
{
    ...
    //Delays, Use SetSeconds, Delay returns true when timer is ready
    IMGUI_API bool          Delay(signed int& timer);
    IMGUI_API void          SetSeconds(signed int& timer, int seconds);
    ...
    IMGUI_API bool          InputLong(const char* label, unsigned long long* v, int step, int step_fast, ImGuiInputTextFlags flags);
    IMGUI_API bool          InputInt2(const char* label, int v[2], ImGuiInputTextFlags flags = 0);
    IMGUI_API bool          InputInt3(const char* label, int v[3], ImGuiInputTextFlags flags = 0);
    IMGUI_API bool          InputInt4(const char* label, int v[4], ImGuiInputTextFlags flags = 0);
    IMGUI_API bool          InputDouble(const char* label, double* v, double step = 0.0, double step_fast = 0.0, const char* format = "%.6f", ImGuiInputTextFlags flags = 0);
    IMGUI_API bool          InputScalarL(const char* label, ImGuiDataType data_type, void* p_data, const void* p_step, const void* p_step_fast, const char* format, ImGuiInputTextFlags flags);
